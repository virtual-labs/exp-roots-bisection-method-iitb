...
function activity1() {
   ...
   <h4 class="center-text fs-28px fb-700">Roots of Equation: Bisection Method</h4>
   <br><br>
...
function internal_calculations_1() {
    ...
    root_val_8 = act1_table_data1[7][5];
    func_val_8 = act1_table_data1[7][6];
    div.innerHTML = '';
    div.innerHTML = `
...
function load_questions() {
   ...
   <div id="question-div">
      <div class="row justify-content-center" style="align-items:center">
         <div class="col-md-5">
            What is function value of 8<sup>th</sup> iteration?
         </div>
         <div class="col-md-4">
      ...
      <div class="row justify-content-center" style="align-items:center">
         <div class="col-md-5">
            What is root value of 8<sup>th</sup> iteration?
         </div>
         <div class="col-md-4">
...
function verify_answer() {
    ...
    if (!verify_values(parseFloat(root_inp.value), parseFloat(root_val_8.toFixed(5)))) {
        root_inp.style.border = '1px solid red';
        alert('Incorrect root value for 8th iteration');
        return;
    }
    else {
